...
package tpsoaptalend.helloworldservicejob_0_1;
...
/**
 * Job: HelloWorldServiceJob Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class HelloWorldServiceJob implements TalendJob, TalendESBJob, TalendESBJobFactory {
	...
	public TalendESBJob newTalendESBJob() {
		HelloWorldServiceJob talendESBJob = new HelloWorldServiceJob();
	...
	private final String jobName = "HelloWorldServiceJob";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					HelloWorldServiceJob.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(HelloWorldServiceJob.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public ESBEndpointInfo getEndpoint() {
		return new ESBEndpointInfo() {
			...
			public String getEndpointUri() {
				...
				return "TPSOAPTALEND_HelloWorldServiceJob";
			}
	...
	class HandlerThread_tESBProviderRequest_1 extends Thread {
		...
		public void run() {
			...
			serverFactory.setWsdlURL(
					"C:/Users/ayoub/OneDrive/Documents/TalendStudioESB/Studio/workspace/TPSOAPTALEND/services/HelloWorldService_0.1.wsdl");
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_TPSOAPTALEND_HelloWorldServiceJob = new byte[0];
		static byte[] commonByteArray_TPSOAPTALEND_HelloWorldServiceJob = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TPSOAPTALEND_HelloWorldServiceJob) {
...
// build root xml tree 
									...
									valueMap.put("loop", treeNodeAPI
											.get_String("row1.payload:/tns:HelloWorldServiceOperationRequest/in"));
									if (valueMap.get("loop") != null) {
										routines.system.NestXMLTool.setText(loop,
												FormatterUtils.fm(valueMap.get("loop"), null));
									}
								}
							}
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final HelloWorldServiceJob HelloWorldServiceJobClass = new HelloWorldServiceJob();

		int exitCode = HelloWorldServiceJobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = HelloWorldServiceJob.class.getClassLoader().getResourceAsStream(
					"tpsoaptalend/helloworldservicejob_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = HelloWorldServiceJob.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : HelloWorldServiceJob");
		}
...
/************************************************************************************************
 * 78482 characters generated by Talend Open Studio for ESB on the 22 octobre
 * 2019 23:07:43 WEST
 ************************************************************************************************/