...
package tpsoaptalend.helloworldserviceconsumer_0_1;
...
/**
 * Job: HelloWorldServiceConsumer Purpose: HelloWorldServiceConsumer<br>
 * Description: <br>
 * 
...
public class HelloWorldServiceConsumer implements TalendJob, TalendESBJob {
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_TPSOAPTALEND_HelloWorldServiceConsumer = new byte[0];
		static byte[] commonByteArray_TPSOAPTALEND_HelloWorldServiceConsumer = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TPSOAPTALEND_HelloWorldServiceConsumer) {
	...
	public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TPSOAPTALEND_HelloWorldServiceConsumer.length) {
					if (length < 1024 && commonByteArray_TPSOAPTALEND_HelloWorldServiceConsumer.length == 0) {
						commonByteArray_TPSOAPTALEND_HelloWorldServiceConsumer = new byte[1024];
					} else {
						commonByteArray_TPSOAPTALEND_HelloWorldServiceConsumer = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TPSOAPTALEND_HelloWorldServiceConsumer, 0, length);
				strReturn = new String(commonByteArray_TPSOAPTALEND_HelloWorldServiceConsumer, 0, length, utf8Charset);
			}
			return strReturn;
		}
										...
										ESBConsumer consumer_tESBConsumer_1 = registry
												.createConsumer(new ESBEndpointInfo() {
													...
													public String getEndpointUri() {
														...
														return "TPSOAPTALEND_HelloWorldServiceConsumer_tESBConsumer_1";
													}
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = HelloWorldServiceConsumer.class.getClassLoader().getResourceAsStream(
					"tpsoaptalend/helloworldserviceconsumer_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 91678 characters generated by Talend Open Studio for ESB on the 22 octobre
 * 2019 22:07:50 WEST
 ************************************************************************************************/