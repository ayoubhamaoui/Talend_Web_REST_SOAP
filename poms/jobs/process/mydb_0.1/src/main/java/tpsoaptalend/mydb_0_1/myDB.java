 ...
 * @status
 */
public class myDB implements TalendJob {
	...
	private final String jobName = "myDB";
	private final String projectName = "TPSOAPTALEND";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(myDB.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void vFlowMeter_getUsers_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public static class RestServiceProviderImpl4TalendJob {
		...
		private final myDB job;

		public RestServiceProviderImpl4TalendJob(myDB job) {
			this.job = job;
		}

		private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap, myDB job) {
	...
	class Thread4RestServiceProviderEndpoint extends Thread {
		...
		public Thread4RestServiceProviderEndpoint(myDB job, String endpointUrl) {
			this.job = job;
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_TPSOAPTALEND_myDB = new byte[0];
		static byte[] commonByteArray_TPSOAPTALEND_myDB = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TPSOAPTALEND_myDB) {
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TPSOAPTALEND_myDB.length) {
					if (length < 1024 && commonByteArray_TPSOAPTALEND_myDB.length == 0) {
						commonByteArray_TPSOAPTALEND_myDB = new byte[1024];
					} else {
						commonByteArray_TPSOAPTALEND_myDB = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TPSOAPTALEND_myDB, 0, length);
				strReturn = new String(commonByteArray_TPSOAPTALEND_myDB, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (execStat) {
					...
					if (execStat) {
						runStat.updateStatOnConnection("meterRowgetUsers" + iterateId, 0, 0);
					}
				...
				try {
					...
					/**
					 * [vFlowMeter_getUsers begin ] start
					 */

					ok_Hash.put("vFlowMeter_getUsers", false);
					start_Hash.put("vFlowMeter_getUsers", System.currentTimeMillis());

					currentComponent = "vFlowMeter_getUsers";
					...
					int tos_count_vFlowMeter_getUsers = 0;

					int count_vFlowMeter_getUsers = 0;

					/**
					 * [vFlowMeter_getUsers begin ] stop
					 */
...
// Start of branch "getUsers"
					if (getUsers != null) {
						...
						/**
						 * [vFlowMeter_getUsers main ] start
						 */
						...
						count_vFlowMeter_getUsers++;

						tos_count_vFlowMeter_getUsers++;

						/**
						 * [vFlowMeter_getUsers main ] stop
						 */

						/**
						 * [vFlowMeter_getUsers process_data_begin ] start
						 */

						currentComponent = "vFlowMeter_getUsers";

						/**
						 * [vFlowMeter_getUsers process_data_begin ] stop
						 */
						...
						if (execStat) {
							runStat.updateStatOnConnection("meterRowgetUsers" + iterateId, 1, 1);
						}
...
// build root xml tree 
						...
						String url_tDBInput_1 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "eservices_tp1"
...
///////////////////////    			
						...
						/**
						 * [vFlowMeter_getUsers process_data_end ] start
						 */

						currentComponent = "vFlowMeter_getUsers";

						/**
						 * [vFlowMeter_getUsers process_data_end ] stop
						 */
					...
					ok_Hash.put("vFlowMeter_getUsers", true);
					end_Hash.put("vFlowMeter_getUsers", System.currentTimeMillis());

					/**
					 * [vFlowMeter_getUsers end ] stop
					 */
					...
					if (execStat) {
						if (resourceMap.get("inIterateVComp") == null
								|| !((Boolean) resourceMap.get("inIterateVComp"))) {
							runStat.updateStatOnConnection("meterRowgetUsers" + iterateId, 2, 0);
						}
					}
			...
			try {
				...
				/**
				 * [vFlowMeter_getUsers finally ] start
				 */

				currentComponent = "vFlowMeter_getUsers";

				/**
				 * [vFlowMeter_getUsers finally ] stop
				 */
	...
	public static void main(String[] args) {
		final myDB myDBClass = new myDB();

		int exitCode = myDBClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = myDB.class.getClassLoader()
					.getResourceAsStream("tpsoaptalend/mydb_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = myDB.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : myDB");
		}
...
/************************************************************************************************
 * 95608 characters generated by Talend Open Studio for ESB on the 23 octobre
 * 2019 10:04:18 WEST
 ************************************************************************************************/